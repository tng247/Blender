...
if(CMAKE_SYSTEM_NAME MATCHES "Linux")
  # Snap packages
  configure_file("${CMAKE_SOURCE_DIR}/build_files/package_spec/snap/snapcraft.yaml.in" "${CMAKE_BINARY_DIR}/snap/snapcraft.yaml")
  add_custom_target(package_snap COMMAND sudo snapcraft WORKING_DIRECTORY "${CMAKE_BINARY_DIR}")
